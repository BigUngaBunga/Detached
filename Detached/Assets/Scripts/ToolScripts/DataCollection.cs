...
public class DataCollection : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < triggers.Length; i++)
        {
            ...
            triggerStructArray[i].x = triggers[i].gameObject.transform.position.x;
            triggerStructArray[i].y = triggers[i].gameObject.transform.position.y;
            triggerStructArray[i].z = triggers[i].gameObject.transform.position.z;
        }
